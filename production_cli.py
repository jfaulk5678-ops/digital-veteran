...
def main():
    ...
    parser.add_argument(
        "--start-dashboard", action="store_true", help="Start web dashboard"
    )
    parser.add_argument(
        "--generate-leads", type=int, help="Generate N production leads"
    )
    ...
    if args.start_dashboard:
        ...
        print(
            "Usage: python production_cli.py [--start-dashboard|--generate-leads N|--deploy|--status]"
        )
