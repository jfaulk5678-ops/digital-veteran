...
class LeadSourcingAgent:
    ...
    def _create_mock_lead(self, lead_id: int, target_signals: list, avoid_signals: list):
        ...
        lead = {
            ...
            "confidence_score": self._calculate_lead_confidence(company_size, industry, target_signals),
    ...
    def _calculate_lead_confidence(self, company_size: str, industry: str, target_signals: list) -> float:
        ...
        if industry.lower() in ["saas", "fintech"] and "high_ticket_positive" in target_signals:
            confidence += 0.2
    ...
    def score_and_filter_leads(self, leads: list, min_confidence: float = 0.6):
        ...
        for lead in leads:
            ...
            lead['recommendation'] = "Pursue" if lead['icp_match_score'] >= min_confidence else "Review"
...
if __name__ == "__main__":
    ...
    for lead in scored_leads:
        print(f"   {lead['company_name']} - Score: {lead['icp_match_score']:.1%} - {lead['recommendation']}")
